...
class ZhCmnEngine:
    ...
    def __init__(self, cfg):
        ...
        model_checkpoint = cfg["engine"][ZhCmnEngine.iso()]["model_checkpoint"]
        ...
        self.temperature = cfg["engine"][ZhCmnEngine.iso()]["temperature"]
        self.top_p = cfg["engine"][ZhCmnEngine.iso()]["top_p"]
